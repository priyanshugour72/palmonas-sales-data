    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-slate-100 px-4 dark:bg-zinc-950">
      ...
      <div className="flex justify-center mb-4">
        ...
        <p className="mt-2 text-center text-sm text-slate-500 dark:text-slate-400">
          Sign in with your <strong className="text-slate-700 dark:text-slate-300">@palmonas.com</strong> account to continue.
        </p>
        <button
          type="button"
          onClick={() => signIn("google", { callbackUrl: "/sales" })}
          className="mt-6 flex w-full items-center justify-center gap-2 rounded-lg bg-slate-900 py-3 px-4 font-medium text-white transition hover:bg-slate-800 dark:bg-slate-100 dark:text-slate-900 dark:hover:bg-slate-200"
        >
